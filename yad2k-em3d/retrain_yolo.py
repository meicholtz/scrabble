...
def process_data(images, boxes=None, im_size=(416, 416)):
    '''processes the data'''
...
def get_detector_mask(boxes, anchors, im_size=(416, 416)):
    '''
...
def create_model(anchors, class_names, load_pretrained=True, freeze_body=True, in_channels=1, save_prefix='', im_size=(416, 416)):
    '''
